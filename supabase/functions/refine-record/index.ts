...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const system = [
      ...
      "VOICE — the proposed_value must read the way a knowledgeable person would explain the field to a new colleague with ZERO prior context: a clear, complete, SELF-CONTAINED definition that stands on its own. LEAD WITH WHAT THE THING IS, affirmatively and in plain language. Do NOT define by negation, do NOT write the field as a rebuttal or correction of any prior, old, or competing framing, and do NOT reference what it 'is not' or 'used to be' (one brief contrast only when it truly aids understanding, never as the opening). State the final definition cleanly as if writing it fresh — never narrate the change. No slogans, hype, or jargon padding; clarity over cleverness. The rationale may explain WHY you changed it, but the field value itself never argues with its old self.",
