...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const pol = await resolveModelPolicy(supabase, { task: "propose_dimensions", fallback: { model: MODEL, effort: "high" } });
    ...
    await logUsage(supabase, { task: "propose_dimensions", model: pol.model, usage: resp.usage });
