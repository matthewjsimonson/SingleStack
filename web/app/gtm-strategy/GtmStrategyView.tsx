  ...
  return (
    <div>
      <div style={{ marginBottom: "var(--sp-3)" }}>
        ...
        <div className="t-sub t-muted" style={{ fontSize: 12.5 }}>GTM signals merge into themes, auto-bucketed into campaign, content, and messaging plays — the go-to-market mirror of the product strategy board.</div>
      </div>
      <ThemesTab lens="gtm" />
    </div>
  );
