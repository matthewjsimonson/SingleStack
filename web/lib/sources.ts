...
export const SOURCE_CATALOG: SourceDef[] = [
  ...
  // ---- External — market & web ---------------------------------------------
  { kind: "website", label: "Website", origin: "external", icon: "🌐", blurb: "Any web page — a competitor's site, a pricing page, a blog. Tracks changes.", live: false, authMode: "none", accessScope: "Read-only: public web pages", needsUrl: true, urlHint: "https://competitor.com/pricing", defaultMaxPerPull: 5, defaultFocus: "gtm" },
  ...
  { kind: "youtube", label: "YouTube", origin: "external", icon: "▶️", blurb: "Video transcripts — demos, talks, webinars. Pulls the transcript, not the video.", live: false, authMode: "none", accessScope: "Read-only: public video transcripts", needsUrl: true, urlHint: "youtube.com/@competitor or a video URL", defaultMaxPerPull: 5, defaultFocus: "both" },
  ...
  { kind: "web_search", label: "Web search", origin: "external", icon: "🔎", blurb: "Ongoing web monitoring — news, launches, mentions.", live: false, authMode: "none", accessScope: "Read-only: public web & news", defaultMaxPerPull: 8, defaultFocus: "both" },
