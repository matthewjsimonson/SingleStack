...
export async function loadDemoData(supabase: SupabaseClient, orgId: string): Promise<{ created: boolean; message: string }> {
  ...
  await step("signals network", async () => {
    ...
    const N: [string, string, string, string, number, string | null][] = [
      ...
      ["arch_platform_rip", "Platform competitors", "Solutions a buyer could swap in for the WHOLE loop \u2014 sense, decide, build, sell in one governed system. The test on every candidate: could a customer cancel us and move everything here?", "competitive", 3, null],
      ["riv_pm_suites", "PM suite vendors", "Productboard-class suites own the Decide leg and are adding AI agents and build ambitions. Watch Spark-class agents moving from suggests to builds, pricing moves, and loop-wide positioning.", "competitive", 3, "arch_platform_rip"],
      ["riv_plg_ops", "New full-loop platforms", "New entrants claiming product + GTM + build in one system are the head-on future. Watch launches, fundraises, and positioning that names the full loop.", "competitive", 3, "arch_platform_rip"],
      ["arch_point_attacks", "Point-solution competitors", "Tools that are direct on ONE capability we own \u2014 they win that job outright and we lose the wedge. Each child names the capability it attacks and who is winning it.", "competitive", 3, null],
      ...
      ["arch_same_job", "Substitute approaches", "No product to rip out \u2014 a different route to the same outcome. These win silently in deals we never see.", "competitive", 2, null],
      ["adj_diy_stack", "DIY tool stacks", "Notion plus AI plus spreadsheets plus a builder \u2014 'we already have tools for each piece' is the default alternative. Watch templates, workflows, and community recipes that stitch the loop by hand.", "competitive", 2, "arch_same_job"],
      ["adj_services", "Agencies & consultants", "Agencies and fractional PMM or product-ops operators run the loop as a service. Watch productized-service offers aimed at our ICP.", "competitive", 2, "arch_same_job"],
      ["adj_inhouse", "Internal builds", "Engineering builds internal tooling instead of buying. Watch engineering-blog posts and open-source internal-tool releases from PLG companies.", "competitive", 2, "arch_same_job"],
      ["arch_diff_game", "Indirect players", "Not competing for the job \u2014 but they shape our buyers, budgets, and category.", "competitive", 1, null],
      ...
      ["ind_provider_upstack", "AI providers entering our space", "A frontier provider shipping a native idea-to-app-to-GTM loop is the standing platform shock. Watch provider PRODUCT moves, not just model releases.", "competitive", 1, "arch_diff_game"],
      ["ind_category_voices", "Analysts & communities", "Analysts, newsletters, and communities defining what PLG ops and AI product management mean \u2014 they set the category we are bought in.", "competitive", 1, "arch_diff_game"],

      // ---- MARKET — direct: our segments, buyers, demand signals; adjacent:
      //      one step out; indirect: the horizon ----
      ["seg_core_icp", "Core segment: Series A\u2013C B2B SaaS", "Our market: 20\u2013200-person B2B software companies building product-led \u2014 big enough for PM and GTM roles, small enough to feel every tool seam.", "market", 3, null],
      ...
      ["seg_devtools", "DevTools companies", "DevTools companies prototype naturally and default to PLG. Watch their product-team hiring and tooling discussions.", "market", 3, "seg_core_icp"],
      ...
      ["dem_hiring", "Hiring demand signals", "First-PMM, growth-PM, and product-ops-plus-AI job postings are direct demand for the loop. Watch job boards for ICP-stage companies.", "market", 3, null],
      ["arch_market_adj", "Adjacent segments & roles", "Nearby segments and roles \u2014 tracked steadily; they become direct as PLG spreads.", "market", 2, null],
      ...
      ["adj_founders", "Founders", "Series-A founders run product AND GTM personally \u2014 the whole-loop pitch lands hardest here. Watch founder communities and accelerator content.", "market", 2, "arch_market_adj"],
      ...
      ["arch_market_ind", "Broader forces", "General movement that reshapes our world without naming it.", "market", 1, null],
      ["ind_ai_governance", "AI regulation & procurement rules", "EU-AI-Act-class rules and SOC 2 scrutiny of AI features shape agentic-tool procurement \u2014 our ratification gate is the answer. Watch enterprise AI-policy news.", "market", 1, "arch_market_ind"],
      ["ind_budget_cycles", "SaaS budget & consolidation trends", "Macro budget cycles and stack-consolidation pressure decide whether one platform beats five tools this year. Watch spend reports and consolidation coverage.", "market", 1, "arch_market_ind"],
      ["ind_future_of_pm", "AI's impact on the PM role", "How AI changes the PM role reshapes demand for the loop. Watch the debate in product-leadership media.", "market", 1, "arch_market_ind"],

      // ---- TECHNOLOGY — direct: embedded + build engines; adjacent: one step
      //      out; indirect: the horizon ----
      ["tech_embedded", "AI models in our product", "Frontier model APIs are load-bearing in the product itself \u2014 agent quality, synthesis honesty, and proposal quality ride the current generation. Watch model releases and capability jumps.", "technology", 3, null],
      ...
      ["t_mcp", "MCP ecosystem", "MCP turns every tool a customer runs into a signal source or an action surface. Watch registry growth and new server releases.", "technology", 3, "tech_embedded"],
      ["tech_build", "Build & codegen tools", "Prompt-to-app and code-generation capability is the Build module's engine \u2014 releases that improve working-app generation move our core wedge. Watch codegen model and tool launches.", "technology", 3, null],
      ["t_codegen_steps", "Codegen breakthroughs", "Long-horizon agents, computer use, and code-executing agents each redraw what 'the PM prototypes it themselves' means. Watch provider research posts and agent benchmarks.", "technology", 3, "tech_build"],
      ["arch_tech_adj", "Adjacent technology", "Technology one step from the core \u2014 shifts here move cost, capability, or buyer expectations.", "technology", 2, null],
      ...
      ["adj_infra", "Infrastructure providers", "Managed Postgres, edge-function, and hosting platforms carry us \u2014 pricing or capability shifts move margins and roadmap. Watch platform changelogs and pricing pages.", "technology", 2, "arch_tech_adj"],
      ["arch_tech_ind", "Broader forces", "Not yet productized or priced \u2014 but it decides the next generation.", "technology", 1, null],
      ["ind_research", "AI research (pre-product)", "Memory, planning, and multi-agent research not yet productized. Watch papers and lab posts for what changes the loop next.", "technology", 1, "arch_tech_ind"],
      ["ind_agentic_reg", "Agent standards & safety rules", "Safety rulesets and standards for autonomous agents shape what we may ship. Watch standards bodies and provider policy changes.", "technology", 1, "arch_tech_ind"],
      ["ind_compute", "AI pricing & compute costs", "API pricing and compute cost curves move our margins and what is feasible to embed. Watch provider pricing moves.", "technology", 1, "arch_tech_ind"],
    ];
