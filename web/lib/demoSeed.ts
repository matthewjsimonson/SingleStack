...
export async function loadDemoData(supabase: SupabaseClient, orgId: string): Promise<{ created: boolean; message: string }> {
  ...
  await step("signals network", async () => {
    ...
    const N: [string, string, string, string, number, string | null][] = [
      ...
      ["essence", "PLG operating platform", "SingleStack is a product-led growth operating platform: one governed system that runs sense, decide, build, sell, and learn for product managers and go-to-market teams together. It replaces the stitched chain of a PM suite, docs, an app builder, and spreadsheets with a single loop over shared records. Every search we run inherits this frame: we compete on the whole loop, not any single leg.", "core", 3, null],
      ["core_problem", "The broken loop", "Product and GTM teams lose the thread between a market signal, the decision it drove, the thing that got built, and whether it sold — the loop breaks at every tool boundary and a person becomes the router between five systems. This is the pain we are bought to remove, so evidence of it — tool-sprawl complaints, handoff failures, 'single source of truth' searches — is direct buying signal wherever it appears.", "core", 3, null],
      ["build_first_class", "Build is first-class", "AI prototyping is a first-class Build module: a PM turns a ratified decision into a real, working prototype rather than another document. This is our sharpest wedge and the claim rivals will contest first, so anything that makes PM-driven building easier, cheaper, or more credible — or that lets a rival claim it — moves our core position.", "core", 3, null],
      ["value_prop", "One system, whole loop", "An idea travels the entire loop without leaving the system: sensed from the market, decided against strategy, legitimately prototyped, sold through usage-qualified leads, and learned from — with agents proposing and humans ratifying every step. The promise is compression: fewer tools, fewer handoffs, one record of why. Signals about consolidation appetite and platform fatigue bear directly on this promise.", "core", 3, null],
      ["living_records", "Living records", "Product and GTM records are living artifacts — signal-fed, agent-maintained, human-ratified — the one source both sides of the company read. They are the memory the loop runs on, which makes trust in AI-maintained records a prerequisite for everything we sell. Evidence about how teams govern AI-written content tells us how ready the market is for this.", "core", 2, null],
      ["hitl_governance", "Human-gated AI", "Every AI change passes a human gate: propose, review, ratify — field by field, with provenance. This is the trust layer that lets agents do real work inside a system of record, and it is our answer to procurement's hardest question. AI-governance rules, audit-trail expectations, and enterprise sign-off requirements all strengthen the case for this design.", "core", 2, null],
      ["business_model", "Who pays and how", "We sell workspace SaaS to Series A–C B2B software companies of roughly 20–200 people; product leadership signs, PMs and PMMs operate it daily. Deal size and packaging sit between point-tool self-serve and enterprise suites, so pricing moves by either neighbor squeeze us. Pricing-page changes and packaging news across our competitive set are always material.", "core", 2, null],
      ...
      ["arch_platform_rip", "Platform competitors", "Products a buyer could adopt INSTEAD of us for the whole loop — suites that sense, decide, and increasingly build in one system. The test for membership is rip-and-replace: could a customer cancel SingleStack and move everything here without assembling other tools? These are the deals we lose whole, so they rank above every other competitive signal. Their launches, pricing, and positioning language live on vendor blogs, release notes, and funding coverage.", "competitive", 3, null],
      ["riv_pm_suites", "PM suite vendors", "Productboard-class product-management suites own the Decide leg — roadmapping, discovery, prioritization — and are adding AI agents with build ambitions; Productboard's Spark is the reference case. They matter because they already hold our buyer's budget line and trust, so each step their agents take from suggesting toward building closes on our Build wedge. The moves that matter: agent releases crossing into artifact creation, pricing that bundles AI, and positioning that names the full loop. Watch their release notes, changelogs, pricing pages, and product announcements.", "competitive", 3, "arch_platform_rip"],
      ["riv_plg_ops", "New full-loop platforms", "New entrants that market product plus GTM plus build in one system are the head-on future — the category we are racing to define before someone else names it. Any credible launch here contests our whole thesis rather than one leg, so even small entrants matter early. The signals that count: launch posts claiming the loop, seed and Series A raises with loop language, and design-partner programs aimed at our ICP. Watch launch platforms, accelerator demo days, and funding announcements.", "competitive", 3, "arch_platform_rip"],
      ["arch_point_attacks", "Point-solution competitors", "Tools that compete head-on for ONE capability we own — they do a single leg of our loop, often deeper than we do, and win that job outright. Each child names the capability under attack, because a lost leg unravels the whole-loop pitch: a buyer who adopts a point tool for Build has less reason to buy our loop. Their feature releases and pricing live on vendor sites and review platforms like G2.", "competitive", 3, null],
      ["pt_app_builders", "AI app builders (Build)", "Prompt-to-app products — Lovable, Cursor, v0, Bolt — generate working software from natural language and own the Build leg outright, with Lovable reportedly near $500M ARR. They attack our sharpest wedge: if PMs already prototype in one of these, our Build module must orchestrate them or beat them. The moves that matter: team and enterprise features, governance and SSO, pricing shifts, and positioning that targets PMs rather than developers. Watch their changelogs, pricing pages, funding coverage, and PM-community adoption threads.", "competitive", 3, "arch_point_attacks"],
      ["pt_ci_tools", "Competitive-intel tools (Sell)", "Klue and Crayon-class competitive-intelligence products own battlecards and win-loss — the Sell leg's intelligence — and are expanding: Klue's Ignition acquisition folds launches and messaging into CI. They matter because they define what 'good' competitive intelligence looks like to our buyers and are creeping toward our GTM artifacts. Material changes: AI-feature launches, acquisitions that widen scope, and mid-market pricing moves. Watch their product blogs, acquisition news, and analyst coverage of the CI category.", "competitive", 3, "arch_point_attacks"],
      ["pt_insight_tools", "Feedback & insight tools (Sense)", "Dovetail and Enterpret-class feedback-intelligence products own the Sense leg: they ingest customer feedback and synthesize themes, and are going agentic — Dovetail now ships autonomous monitoring agents. They matter because always-on synthesis is table stakes our Signals engine must match, and because a team satisfied with its insight tool resists a loop pitch. Watch their feature releases, agent launches, and product-team positioning on their blogs and release notes.", "competitive", 3, "arch_point_attacks"],
      ["arch_same_job", "Substitute approaches", "Ways buyers get the same outcome without buying a competing product — nothing to rip out, no vendor to displace, which makes them invisible in win-loss data unless we look. They cap our pricing and lengthen deals because 'do nothing new' is always on the table. Evidence lives in community templates, job posts, and how our ICP describes their current stack.", "competitive", 2, null],
      ["adj_diy_stack", "DIY tool stacks", "Teams stitch Notion, AI assistants, spreadsheets, and a code builder into a home-made loop — 'we already have tools for each piece' is the default objection in every deal. Notion's Custom Agents and marketplace templates keep making this cheaper and more capable. What matters: template ecosystems that package PM workflows, agent features in workspace tools, and community recipes that connect the legs. Watch workspace-tool release notes, template marketplaces, and PM-community workflow threads.", "competitive", 2, "arch_same_job"],
      ["adj_services", "Agencies & consultants", "Agencies and fractional PMM or product-ops operators run the loop as a service for exactly our ICP stage — a company that hires the service defers the platform purchase. Productized offerings with fixed scope and price are the sharpest version. What matters: new productized-service launches aimed at Series A–C SaaS and their pricing. Watch service marketplaces, fractional-operator communities, and positioning on agency sites.", "competitive", 2, "arch_same_job"],
      ["adj_inhouse", "Internal builds", "Engineering teams build internal tooling instead of buying — increasingly plausible now that AI makes internal tools cheap to produce. This substitute grows exactly when our Build thesis proves true, so it needs steady watching. What matters: engineering-blog posts describing home-built PM or GTM tooling, open-source releases of internal tools, and 'build vs buy' discourse in our segment. Watch engineering blogs of PLG companies and open-source release feeds.", "competitive", 2, "arch_same_job"],
      ["arch_diff_game", "Indirect players", "Companies not competing for our job that still shape our buyers, budgets, and category — they set expectations, absorb spend, and can pivot into our space with one product decision. They rank below direct threats but their moves often precede category shifts by quarters.", "competitive", 1, null],
      ["ind_plg_analytics", "PLG analytics & telemetry", "Pendo and Amplitude-class products own product analytics — the Learn leg's telemetry — and share our budget line; both are moving from measurement toward decisions, with Amplitude shipping agentic analytics and Pendo acquiring roadmapping. A buyer who believes analytics plus agents equals the loop delays buying us. What matters: packaging that bundles decision or roadmap features, acquisitions of PM tooling, and agent launches. Watch their product announcements, acquisition news, and pricing pages.", "competitive", 1, "arch_diff_game"],
      ["ind_provider_upstack", "AI providers entering our space", "The frontier labs — OpenAI, Anthropic, Google — periodically ship products, not just models: OpenAI's Workspace Agents already sells governed, shared work agents. A provider shipping a native idea-to-app-to-GTM flow would compress our category overnight, making this the standing platform shock. What matters: PRODUCT launches from providers (agents, workspaces, app builders), their pricing, and their push into business workflows. Watch provider product blogs and launch events, distinct from model release notes.", "competitive", 1, "arch_diff_game"],
      ["ind_category_voices", "Analysts & communities", "Analysts, newsletters, and practitioner communities decide what 'PLG ops' and 'AI product management' mean — and therefore which category we are bought in and who we are compared against. A Gartner category or a dominant newsletter framing can redraw our competitive set without any product shipping. What matters: new market-guide or MQ categories touching our space, influential essays naming the loop, and community consensus shifts. Watch analyst publication calendars, leading product newsletters, and community discussions.", "competitive", 1, "arch_diff_game"],

      // ---- MARKET — direct: our segments, buyers, demand signals; adjacent:
      //      one step out; indirect: the horizon ----
      ["seg_core_icp", "Core segment: Series A-C B2B SaaS", "Our market is 20–200-person B2B software companies building product-led: big enough to have distinct PM and GTM roles, small enough that tool seams hurt weekly and one platform decision can carry. Their funding, hiring, and tooling news is the highest-relevance market signal we track. It lives in funding announcements, launch platforms, and the communities where operators at this stage compare stacks.", "market", 3, null],
      ["seg_plg_native", "PLG-native startups", "Self-serve-first, usage-priced startups run the whole motion we automate — the sharpest fit inside the segment and the earliest adopters of AI-native operations; Lovable-class companies are the archetype. Their behavior previews what the broader segment does next. What matters: their scaling milestones, the tools they publicly adopt, and how they describe their product-to-GTM handoffs. Watch launch feeds, PLG community threads, and scaling stories in startup press.", "market", 3, "seg_core_icp"],
      ["seg_devtools", "DevTools companies", "Developer-tools companies prototype naturally, default to PLG, and staff technical PMs — a beachhead vertical where our Build module needs the least persuasion; Replit's trajectory shows the segment's momentum. What matters: their product-team hiring, tooling debates, and how their PMs describe prototyping workflows. Watch devtools company blogs, hiring pages, and the communities where their product teams gather.", "market", 3, "seg_core_icp"],
      ["per_econ_buyer", "Head of Product / VP Product", "The economic buyer: product leadership owns the tool budget and personally carries the broken sense-to-ship thread; industry surveys now show most product leaders using AI prototyping and predicting role consolidation. What they read and repeat becomes our deal language. What matters: leadership surveys, conference keynote themes, and the reports that shape how they justify platform spend. Watch product-leadership publications, major product conferences, and CPO-survey releases.", "market", 3, null],
      ["per_pm", "Product managers", "The daily operator: PMs sense, decide, and increasingly prototype with AI — their newsletters now rank prototyping stacks the way developers once ranked IDEs. Their frustration with tool sprawl is our wedge, and their AI fluency sets how fast our Build module lands. What matters: which tools PM influencers rank, tool-sprawl complaints, and prototyping workflow debates. Watch the leading PM newsletters and podcasts, product communities, and AI-prototyping threads.", "market", 3, "per_econ_buyer"],
      ["per_pmm", "PMM / GTM leads", "The second operator: product marketers turn the living record into messaging, battlecards, and campaigns, and their profession is being re-measured around revenue impact with AI as everyday practice. Their willingness to trust AI-maintained GTM artifacts gates half our loop. What matters: how PMM work is being redefined, which AI tools their community adopts, and what their industry reports measure. Watch PMM community publications, their annual state-of reports, and GTM newsletters.", "market", 3, null],
      ["dem_hiring", "Hiring demand signals", "Job postings are direct demand evidence: a first-PMM hire, a growth PM, or product-ops roles paired with AI signal exactly the maturity moment we sell into — and name the account. Hiring data also shows role clarity problems we solve; PMM hiring surveys report success metrics remain undefined. What matters: posting volume and language for these roles at Series A–C SaaS companies. Watch startup job boards and hiring-trend reports for product and PMM roles.", "market", 3, null],
      ["arch_market_adj", "Adjacent segments & roles", "Segments and roles one step from the core: not tracked as prospects yet, tracked as expansion paths and early indicators — each becomes direct as product-led motions spread.", "market", 2, null],
      ["adj_vertical_saas", "Vertical SaaS adopting PLG", "Vertical SaaS companies add product-led motions when their sales-led growth stalls, arriving with compliance questions and less PLG fluency — a later but real expansion segment. Their transformation stories mark the category spreading beyond horizontal SaaS. What matters: PLG-transformation case studies, growth-role hires in vertical SaaS, and vertical-specific tooling launches. Watch vertical SaaS trade coverage and growth-community discussions.", "market", 2, "arch_market_adj"],
      ["adj_founders", "Founders", "At Series A the founder often IS product and GTM in one person — the whole-loop pitch lands hardest here and ratification is fastest, but the budget is smallest. Founder communities also incubate the operating norms our ICP adopts a year later. What matters: how founders describe their product-to-GTM workflow and which tools accelerators recommend. Watch founder communities, accelerator content, and early-stage operator podcasts.", "market", 2, "arch_market_adj"],
      ["adj_growth_revops", "Growth & RevOps leads", "Growth and RevOps leaders own the usage-to-pipeline machinery our Sell leg automates — they arrive with the data, adopt PQL scoring first, and expand us from product into revenue teams. Their tooling debates signal readiness for usage-based selling. What matters: PQL and usage-based-sales discourse, RevOps tool consolidation, and who owns 'product signals' in revenue orgs. Watch RevOps and growth communities and their tooling surveys.", "market", 2, "arch_market_adj"],
      ["arch_market_ind", "Broader forces", "Movement that reshapes our market without naming it — regulation, budgets, and the discourse redefining our buyers' jobs. Caught on a slower cadence, weighed lightly, never chased.", "market", 1, null],
      ["ind_ai_governance", "AI regulation & procurement rules", "AI rules are entering SaaS procurement: EU AI Act transparency duties take effect August 2026 and enterprise questionnaires increasingly probe AI features, audit trails, and human oversight. Our human-ratification design is the answer, so these rules are tailwind if we track them and liability if we don't. What matters: enforcement milestones, compliance-framework updates like SOC 2 guidance touching AI, and procurement-language shifts. Watch regulatory trackers, legal-firm briefings, and enterprise-buyer policy announcements.", "market", 1, "arch_market_ind"],
      ["ind_budget_cycles", "SaaS budget & consolidation trends", "Software budgets decide whether 'one platform' beats 'five tools' this cycle: current spend data shows AI-native app spend doubling while AI point tools sit under 40% utilized — consolidation pressure that favors our pitch. What matters: annual SaaS spend indexes, stack-consolidation surveys, and utilization data on AI tools. Watch SaaS-management vendor reports, procurement surveys, and CFO-tooling coverage.", "market", 1, "arch_market_ind"],
      ["ind_future_of_pm", "AI's impact on the PM role", "The loudest conversation in product media is what AI does to the PM job — 'product builders' rising, headcount consolidating, prototyping becoming a PM skill. This discourse creates the demand narrative our Build story attaches to, and its direction tells us whether the market is moving toward or away from our thesis. What matters: influential essays, survey data on PM role changes, and conference themes. Watch product-leadership media, PM community debates, and role-evolution research.", "market", 1, "arch_market_ind"],

      // ---- TECHNOLOGY — direct: embedded + build engines; adjacent: one step
      //      out; indirect: the horizon ----
      ["tech_embedded", "AI models in our product", "Frontier model APIs are load-bearing inside SingleStack: agent quality, synthesis honesty, and proposal quality all ride the current Claude-class generation, and each capability jump (long context, adaptive reasoning) directly upgrades what our product does. A model release is a product event for us. What matters: new frontier releases, context and reasoning improvements, and reliability or policy changes on the APIs we run. Watch provider release notes, model cards, and API changelogs.", "technology", 3, null],
      ["t_agent_sdks", "Agent frameworks & SDKs", "Agent SDKs — Claude's Agent SDK and rivals like OpenAI's Agents SDK — define what our executive agents can do: tool use, memory, sandboxed execution, long-horizon work. Their release cadence sets our agent-runtime ceiling and switching costs. What matters: new orchestration primitives, sandbox and memory features, and breaking changes. Watch SDK changelogs, provider developer blogs, and framework release notes.", "technology", 3, "tech_embedded"],
      ["t_mcp", "MCP ecosystem", "The Model Context Protocol is our connector fabric — every tool a customer already runs becomes a signal source or action surface through it, and the ecosystem is compounding: Linux Foundation governance, roughly ten thousand public servers, and a spec adding Tasks and Apps primitives. Its growth multiplies our integration surface for free. What matters: spec releases, registry growth, and high-value server launches in product and GTM tooling. Watch the MCP blog, spec repository, and registry announcements.", "technology", 3, "tech_embedded"],
      ["tech_build", "Build & codegen tools", "Prompt-to-app and code-generation capability is the engine under our Build module — every release that improves working-app generation (v0's sandbox runtime and PR workflows are the current bar) raises what 'PM prototypes it' can mean in our product. We ride this capability curve whether we build on it or compete with it. What matters: codegen tool launches, quality benchmarks on app generation, and production-readiness features like git workflows. Watch builder-tool changelogs, codegen benchmarks, and launch coverage.", "technology", 3, null],
      ["t_codegen_steps", "Codegen breakthroughs", "Step-changes in autonomous coding — long-horizon agents, computer use, code-executing agents — each redraw how much building a PM can safely delegate; current benchmarks like OSWorld 2.0 show agents completing only a fifth of long tasks, which calibrates how much autonomy we grant. What matters: benchmark jumps on long-horizon and agentic coding tasks, and provider research on multi-step reliability. Watch agent benchmarks, provider research posts, and evaluation papers.", "technology", 3, "tech_build"],
      ["arch_tech_adj", "Adjacent technology", "Technology one step from the core stack — it moves our costs, our capabilities, or our buyers' expectations without being load-bearing today.", "technology", 2, null],
      ["adj_open_models", "Open-weight models", "Open-weight releases — DeepSeek, Qwen, Llama-class — set the price floor for embedded intelligence and the ceiling for self-host demands, with current open coding models within points of frontier on SWE-bench-class tests. They are our cost lever and our enterprise-deployment fallback. What matters: releases approaching frontier quality on our workloads, license terms, and hosted-inference pricing. Watch open-model release announcements, benchmark leaderboards, and inference-provider pricing.", "technology", 2, "arch_tech_adj"],
      ["adj_ai_gtm", "AI-for-GTM products", "AI products running GTM work — enrichment, outreach, content, scoring; Clay's agent passing a billion research runs is the marker — are both tooling our Sell leg can orchestrate and the expectation-setters for what 'AI-powered GTM' means to our buyers. What matters: category-leading launches, adoption milestones, and integration patterns our customers will expect. Watch GTM-tool launch coverage, their usage announcements, and RevOps community adoption threads.", "technology", 2, "arch_tech_adj"],
      ["adj_infra", "Infrastructure providers", "Managed Postgres, edge functions, and hosting — the Supabase and Vercel-class platforms we ride — set our margins and deploy-loop speed; recent examples include bundled faster build machines at unchanged seat prices. Their pricing and capability shifts hit our unit economics directly. What matters: pricing changes, resource-limit changes, and platform capabilities that alter our architecture options. Watch provider changelogs, pricing pages, and platform announcements.", "technology", 2, "arch_tech_adj"],
      ["arch_tech_ind", "Broader forces", "Technology movement not yet productized or priced — research, standards, and economics that decide the next generation rather than this quarter.", "technology", 1, null],
      ["ind_research", "AI research (pre-product)", "Research on memory, planning, and multi-agent coordination previews the capabilities our loop gets next — today's paper on persistent agent memory is next year's living-record upgrade. Tracking it early shapes our architecture bets. What matters: credible results on agent memory, long-horizon planning, and coordination that survive replication. Watch major lab publications, arXiv agent research, and reputable research summaries.", "technology", 1, "arch_tech_ind"],
